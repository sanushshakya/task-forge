...
describe('calculateStreak', () => {
  ...
  it('should return 0 for no entries on any day', () => {
    const entries: Date[] = [
      new Date(2023, 0, 1),
      new Date(2023, 0, 3),
      new Date(2023, 0, 5)
  ...
  it('should return 1 for one entry that is not consecutive', () => {
    const entries: Date[] = [
      new Date(2023, 0, 1),
      new Date(2023, 0, 3)
    ];
  ...
  it('should return 3 for three consecutive days with a gap', () => {
    const entries: Date[] = [
      new Date(2023, 0, 1),
      new Date(2023, 0, 4),
      new Date(2023, 0, 7)
  ...
  it('should return 0 for entries that are not in reverse chronological order', () => {
    const today = new Date();
    const yesterday = new Date(today);
    yesterday.setDate(yesterday.getDate() - 1);
    ...
    const entries: Date[] = [yesterday, today, dayBeforeYesterday];
    expect(calculateStreak(entries)).toBe(0);
  });

  it('should return 3 for three consecutive days in reverse chronological order', () => {
    const today = new Date();
    const yesterday = new Date(today);
    yesterday.setDate(yesterday.getDate() - 1);
    ...
    const entries: Date[] = [yesterday, dayBeforeYesterday, today];
    expect(calculateStreak(entries)).toBe(3);
  });
});